...
import ai.acyclic.graph.commons.diff.StringDiff.SuperSet
...
//      .mkString("\n")
  ...
  describe("Singleton") {
    ...
    it("global") {
      ...
      TypeViz[TypeVizSpec.singleton.type].toString.shouldBe(
        """
          |-+ ai.acyclic.graph.commons.viz.TypeVizSpec.singleton.type
          | !-+ Int
          |   !-+ AnyVal
          |     !-- Any
          |""".stripMargin
    ...
    it("... with Arg") {
      ...
      TypeViz[TypeVizSpec.singletonWArg.type].toString.shouldBe(
        """
          |-+ ai.acyclic.graph.commons.viz.TypeVizSpec.singletonWArg.type
          | !-+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[Int]
          |   :       ┏ -+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg [ 1 ARG ] :
          |   :       ┃  !-+ Int
          |   :       ┃    !-+ AnyVal
          |   :       ┃      !-- Any ............................................................................. [0]
          |   !-+ java.io.Serializable
    ...
    it("global Witness.T") {
      ...
      infer(singletonW.value)
        .shouldBe(
          """
            |-+ ai.acyclic.graph.commons.viz.TypeVizSpec.singletonW.T
            | !-+ Int
            |   !-+ AnyVal
            |     !-- Any
            |""".stripMargin
  ...
  describe("type alias") {
    ...
    it("global") {
      ...
      TypeViz[Alias].toString.shouldBe(
        """
          |-+ Int(3) ≅ ai.acyclic.graph.commons.viz.TypeVizSpec.Alias
          | !-+ Int
          |   !-+ AnyVal
          |     !-- Any
          |""".stripMargin
    ...
    describe("generic") {
      ...
      it("Default") {
        TypeViz[AliasWArg].toString.shouldBe(
          """
            |-+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[Double] ≅ ai.acyclic.graph.commons.viz.TypeVizSpec.AliasWArg
            | :       ┏ -+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg [ 1 ARG ] :
            | :       ┃  !-+ Double
            | :       ┃    !-+ AnyVal
            | :       ┃      !-- Any ............................................................................. [0]
      ...
      it("DeAlias") {
        ...
        TypeVizDeAlias[AliasWArg].toString.shouldBe(
          """
            |-+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[Double]
            | :       ┏ -+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg [ 1 ARG ] :
            | :       ┃  !-+ Double
            | :       ┃    !-+ AnyVal
            | :       ┃      !-- Any ............................................................................. [0]
    ...
    describe("generic of generic") {
      ...
      it("Default") {
        TypeViz[AliasWArg2].toString.shouldBe(
          """
            |-+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[Double]] ≅ ai.acyclic.graph.commons.viz.TypeVizSpec.AliasWArg2
            | :       ┏ -+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg [ 1 ARG ] :
            | :       ┃  !-+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[Double]
            | :       ┃    :       ┏ -+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg [ 1 ARG ] :
            | :       ┃    :       ┃  !-+ Double
      ...
      it("DeAlias") {
        ...
        TypeVizDeAlias[AliasWArg2].toString.shouldBe(
          """
            |-+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[Double]]
            | :       ┏ -+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg [ 1 ARG ] :
            | :       ┃  !-+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg[Double]
            | :       ┃    :       ┏ -+ ai.acyclic.graph.commons.viz.TypeVizSpec.WArg [ 1 ARG ] :
            | :       ┃    :       ┃  !-+ Double
  ...
  describe("path-dependent") {
    ...
    it("with final type in path") {
      ...
      TypeViz[EE.D].toString.shouldBe(
        """
          |-+ Int ≅ ai.acyclic.graph.commons.viz.TypeVizSpec.EE.D
          | !-+ AnyVal
          |   !-- Any
          |""".stripMargin
      )
  ...
  it("this") {
    ...
    TypeViz[e.THIS].toString.shouldBe(
      """
        |-+ e.type ≅ e.THIS
        | !-+ ai.acyclic.graph.commons.viz.TypeVizSpec.EE
        |   !-+ ai.acyclic.graph.commons.viz.TypeVizSpec.E
        |     !-+ Object
        |       !-- Any
        |""".stripMargin
    )
