...
trait ForwardUnary extends Local.AnyGraph.Forward.Ops.Unary {

  {
    implicitly[ArgLaw <:< Local.AnyGraph.Forward._Axiom]
  }
...
object ForwardUnary {
  ...
  case class ^[L <: Local.AnyGraph.Forward._Axiom, V](
