...
object Hom extends Hom_Imp0 {
  ...
  implicit class _fnExt[I, O](self: Fn[I, O]) extends Serializable {
    ...
    def trace: ai.acyclic.prover.commons.jit.tracingV2.Tracing[I, O] =
      ai.acyclic.prover.commons.jit.tracingV2.Tracing(self.normalForm)
  }

  implicit class _thunkExt[O](self: Thunk[O]) extends Serializable {

    def trace: ai.acyclic.prover.commons.jit.tracingV2.Tracing[Unit, O] =
      ai.acyclic.prover.commons.jit.tracingV2.Tracing(self.normalForm)
  }
