...
////
////  /**
////    * similar to [[FromFlat]], but has a fallback case that can convert any type A into `A ><: Empty`
////    */
...
////  }
////
////  trait FromFlat extends FromFlat with FromFlatLowPriority
////  object FromFlat extends FromFlat
//}
