...
class TypeVizSpec extends BaseSpec with TypeViz.TestFixtures {
  ...
  it("trait with generic") {
    ...
    viz
      ...
      .shouldBe(
        """
        |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K[ai.acyclic.prover.meta2.viz.TypeVizSpec.S1]
        |:       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K [ 1 ARG ] :
        |:       ┃ !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S1
        |:       ┃   !-- Object ... (see [0])
        |!-- Object .......................................................................... [0]
        |""".stripMargin
      )
  ...
  it("trait with self-referencing arg") {
    ...
    viz
      ...
      .shouldBe(
        """
        |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S2 ...................................... [1]
        |!-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S1
        |: !-- Object .......................................................................... [0]
        |!-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K[ai.acyclic.prover.meta2.viz.TypeVizSpec.S2]
        |  :       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K [ 1 ARG ] :
        |  :       ┃ !-- ai.acyclic.prover.meta2.viz.TypeVizSpec.S2 ... (see [1])
        |  !-- Object ... (see [0])
        |""".stripMargin
      )
    ...
    viz
      ...
      .shouldBe(
        """
        |                                                    ┌──────────────────────────────────────────┐
        |                                                    │ai.acyclic.prover.meta2.viz.TypeVizSpec.S2│
        |                                                    └──────────────┬─────────────┬─────────────┘
        |                                                                   │             │
        |                       ┌───────────────────────────────────────────┘             │
        |                       │                                                         v
        ...
        |                       │                      │ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K[ai.acyclic.prover.meta2.viz.TypeVizSpec.S2]              │
        |                       │                      │      ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K [ 1 ARG ] :                                    │
        |                       v                      │      ┃ !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S2 ...................................... [1]    │
        | ┌──────────────────────────────────────────┐ │      ┃   !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S1                                             │
        | │ai.acyclic.prover.meta2.viz.TypeVizSpec.S1│ │      ┃   : !-- Object .......................................................................... [0]│
        | └─────────────────────┬────────────────────┘ │      ┃   !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K[ai.acyclic.prover.meta2.viz.TypeVizSpec.S2]│
        |                       │                      │      ┃     :       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.S2K [ 1 ARG ] :                      │
        |                       │                      │      ┃     :       ┃ !-- ai.acyclic.prover.meta2.viz.TypeVizSpec.S2 ... (see [1])                   │
        |                       │                      │      ┃     !-- Object ... (see [0])                                                                 │
  ...
  describe("Singleton") {
    ...
    it("global") {
      ...
      TypeViz[TypeVizSpec.singleton.type].toString.shouldBe(
        """
          |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.singleton.type
          |!-- Int
          |""".stripMargin
      )
    }
    ...
    it("... with Arg") {
      ...
      TypeViz[TypeVizSpec.singletonWArg.type].toString.shouldBe(
        """
          |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.singletonWArg.type
          |!-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[Int]
          |  :       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg [ 1 ARG ] :
          |  :       ┃ !-- Int
          |  !-- java.io.Serializable
          |  !-- Product
          |  !-- Object
    ...
    it("case class constructor") {
      ...
      infer(W)
        .shouldBe(
          """
            |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.W.type
            |!-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.W.type
            |  !-- java.io.Serializable
            |  !-- Object
            |""".stripMargin
    ...
    it("... with args") {
      ...
      infer(WArg)
        .shouldBe(
          """
            |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg.type
            |!-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg.type
            |  !-- java.io.Serializable
            |  !-- Object
            |""".stripMargin
  ...
  it("refined") {
    ...
    v.toString.shouldBe(
      """
        |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.W{val v: Int(3)} ≅ ai.acyclic.prover.meta2.viz.TypeVizSpec.Refined
        |!-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.W{val v: Int(3)}
        |  !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.W
        |    !-- java.io.Serializable
        |    !-- Product
        |    !-- Object
        |""".stripMargin
  ...
  describe("type alias") {
    ...
    it("global") {
      ...
      TypeViz[Alias].toString.shouldBe(
        """
          |- Int(3) ≅ ai.acyclic.prover.meta2.viz.TypeVizSpec.Alias
          |""".stripMargin
      )
    }
    ...
    describe("generic") {
      ...
      it("Default") {
        TypeViz[AliasWArg].toString.shouldBe(
          """
            |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[Double] ≅ ai.acyclic.prover.meta2.viz.TypeVizSpec.AliasWArg
            |:       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg [ 1 ARG ] :
            |:       ┃ !-- Double
            |!-- java.io.Serializable
            |!-- Product
      ...
      it("DeAlias") {
        ...
        TypeVizDeAlias[AliasWArg].toString.shouldBe(
          """
            |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[Double]
            |:       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg [ 1 ARG ] :
            |:       ┃ !-- Double
            |!-- java.io.Serializable
            |!-- Product
    ...
    describe("generic of generic") {
      ...
      it("Default") {
        TypeViz[AliasWArg2].toString.shouldBe(
          """
            |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[Double]] ≅ ai.acyclic.prover.meta2.viz.TypeVizSpec.AliasWArg2
            |:       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg [ 1 ARG ] :
            |:       ┃ !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[Double]
            |:       ┃   :       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg [ 1 ARG ] :
            |:       ┃   :       ┃ !-- Double
      ...
      it("DeAlias") {
        ...
        TypeVizDeAlias[AliasWArg2].toString.shouldBe(
          """
            |+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[Double]]
            |:       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg [ 1 ARG ] :
            |:       ┃ !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg[Double]
            |:       ┃   :       ┏ + ai.acyclic.prover.meta2.viz.TypeVizSpec.WArg [ 1 ARG ] :
            |:       ┃   :       ┃ !-- Double
  ...
  describe("path-dependent") {
    ...
    it("with final type in path") {
      ...
      TypeViz[EE.D].toString.shouldBe(
        """
          |- Int ≅ ai.acyclic.prover.meta2.viz.TypeVizSpec.EE.D
          |""".stripMargin
      )
  ...
  it("this") {
    ...
    TypeViz[e.THIS].toString.shouldBe(
      """
        |+ e.type ≅ e.THIS
        |!-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.EE
        |  !-+ ai.acyclic.prover.meta2.viz.TypeVizSpec.E
        |    !-- Object
        |""".stripMargin
    )
  }
